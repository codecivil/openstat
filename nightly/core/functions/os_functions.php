...
?>
	...
	<?php
		...
		{
			unset($_stmt_array); $_stmt_array = array();
			$_stmt_array['stmt'] = "SELECT keymachine,keyreadable,edittype,referencetag FROM ".$_table."_permissions WHERE ( `role_".$_SESSION['os_role']."` + `role_".$_SESSION['os_parent']."` ) MOD 8 < 4 ORDER BY CAST(realid AS DECIMAL(6,3))"; //only select fields the user may insert!
